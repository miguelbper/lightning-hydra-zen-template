...
def gaussian_noise(inpt: torch.Tensor, mean: float = ..., sigma: float = ..., clip: bool = ...) -> torch.Tensor:
...
def gaussian_noise_image(image: torch.Tensor, mean: float = ..., sigma: float = ..., clip: bool = ...) -> torch.Tensor:
    ...

@_register_kernel_internal(gaussian_noise, tv_tensors.Video)
def gaussian_noise_video(video: torch.Tensor, mean: float = ..., sigma: float = ..., clip: bool = ...) -> torch.Tensor:
    ...
...
def sanitize_bounding_boxes(bounding_boxes: torch.Tensor, format: Optional[tv_tensors.BoundingBoxFormat] = ..., canvas_size: Optional[Tuple[int, int]] = ..., min_size: float = ..., min_area: float = ...) -> Tuple[torch.Tensor, torch.Tensor]:
